...
#include "MMRoom_Class_A.generated.h"

/**
 * 
 */
UCLASS()
class MYSTICMAZE_API AMMRoom_Class_A : public AMMRoomBase
{
	GENERATED_BODY()
...
private: // 뷰포트에서 사용되는 변수들
	...
	UPROPERTY(EditAnywhere, Category = "Door", Meta = (AllowPrivateAccess = "true"))
	TObjectPtr<UBoxComponent> North; // 북쪽 문을 열고 닫고 방을 스폰하기 위한 콜리전
	UPROPERTY(EditAnywhere, Category = "Door", Meta = (AllowPrivateAccess = "true"))
	TObjectPtr<UBoxComponent> South; // 남쪽 문을 열고 닫고 방을 스폰하기 위한 콜리전
	UPROPERTY(EditAnywhere, Category = "Door", Meta = (AllowPrivateAccess = "true"))
